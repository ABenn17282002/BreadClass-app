                ...
                <form method="POST" action="">
                    ...
                    <div class="max-w-2xl py-4 mx-auto">
                        ...
                        <div>
                            ...
                            <x-jet-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$teacher->name" required autofocus />
                        </div>
                        <div class="mt-4">
                            <x-jet-label for="email" value="{{ __('Email') }}" />
                            <x-jet-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$teacher->email" required autocomplete="username" />
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="p-3 w-full flex justify-around mb-3">
                            <button type="button" onclick="location.href='{{ route('teacher.dashboard')}}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
