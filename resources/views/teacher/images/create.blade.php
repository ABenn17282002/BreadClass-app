                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-full flex justify-around mt-4">
                                        {{-- 戻る --}}
                                        <button type="button" onclick="location.href='{{ route('teacher.image.list')}}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
                                        {{-- 登録ボタン --}}
